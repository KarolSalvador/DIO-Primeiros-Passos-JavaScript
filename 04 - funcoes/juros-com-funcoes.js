...
if (formaPagamento < 1 || formaPagamento > 4) {
    ...
    console.log("O valor a ser pago é de: R$" + (aplicarDesconto(precoEtiqueta, 10)));

}else if (formaPagamento === 2) {
    console.log("O valor a ser pago é de: R$" + (aplicarDesconto(precoEtiqueta, 15)));

} else if (formaPagamento === 3) {
    console.log("O valor a ser pago é de: R$" + precoEtiqueta);

} else {
    console.log("O valor a ser pago é de: R$" + (aplicarJuros(precoEtiqueta, 10)));

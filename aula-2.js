...
const numeroDivisivelPor5 = (numero % 5) === 0; //o % é utilizado para pegar o resto da divisão

//if é uma forma de criar condicionais para direcionar o que irá acontecer de acordo com a condição
if (numero === 0) {
    console.log("Número inválido");

} else if (numeroDivisivelPor5) { //usado para testar uma nova condição quando a anterior no if for falsa.
    console.log("Sim");
